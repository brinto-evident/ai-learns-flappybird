...
bg_img = pygame.transform.scale(pygame.image.load(os.path.join("assets","bg.png")).convert_alpha(), (600, 800))
...
class Bird:
    ...
    def draw(self, win):
        ...
        if self.img_count <= self.ANIMATION_TIME:
            ...
            self.img = self.assets[1]
        elif self.img_count <= self.ANIMATION_TIME*3:
            self.img = self.assets[2]
